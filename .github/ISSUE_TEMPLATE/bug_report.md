...
### composable-dao version/commit hash
State the version of composable-dao where you've encountered the bug or, if built off a specific commit, the relevant commit hash.
- e.g. `v0.9` or `ed53bcd`
